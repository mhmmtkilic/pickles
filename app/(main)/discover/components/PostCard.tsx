import { ArrowUp, ArrowDown, Heart, MessageCircle, Bookmark, MoreHorizontal } from 'lucide-react';
...
export function PostCard({ author, content, timestamp, upvotes, categories }: PostCardProps) {
