import { Download, MessageCircle, Star, FileText, FileSpreadsheet, Archive, ArrowUp, ArrowDown, Bookmark, MoreHorizontal, Share2 } from 'lucide-react';
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-1">
              <button 
                className="p-2 rounded-md text-gray-400 hover:text-accent hover:bg-secondary transition-all"
                title="Kaydet"
              >
